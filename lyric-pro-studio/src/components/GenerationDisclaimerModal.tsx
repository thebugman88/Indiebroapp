...
export const GenerationDisclaimerModal: React.FC<GenerationDisclaimerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-start sm:items-center justify-center overflow-y-auto p-2 sm:p-4">
      <div className="bg-zinc-950 border border-zinc-800 max-w-xl w-full rounded-2xl p-4 sm:p-6 shadow-2xl space-y-5 max-h-[calc(100dvh-1rem)] sm:max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
